        ...
        <Row className='bg-light '>
            ...
            <Col sm={12}>
                <Card
                    ...
                    <Card.Body>
                        <Card.Title className='text-center text-success'>Easy sales tracking</Card.Title>
            ...
            <Col sm={12} className='g-3' >
                <Card style={{ backgroundColor: "#fff4ed" }} className='container rounded rounded-pill'>
                    ...
                    <Card.Body>
                        <Card.Title className='text-center text-primary'>Easy sales tracking</Card.Title>
                        <Card.Text className='text-center'>
